...
<div align="center"><font size="9" color="Lime">WelCome To India</font></div>
<hr>
<%
...
String q = "SELECT * from Hotell h where h.Country = 'INDIA'";
...
out.write("</tr>");
	...
	out.println("<font size=\"5\" color =\"#990000\">");
...
<div align='center'>
<a href= "registerPage.jsp"><input type="submit" value='Click Here To Register'></a>
</div>
