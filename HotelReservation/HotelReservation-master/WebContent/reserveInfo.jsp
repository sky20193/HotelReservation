...
<script type="text/javascript">
    function validate_form() {
      ...
      var CIDValue = document.forms["confirmForm"]["confirm"].value;
      if (CIDValue.length != 9 && CIDValue.length != 10) {
        alert("A valid Confirmtaion Number is either 9 or 10 digits!");
        return false;
      }
      return true;
    }
...
<form name ="confirmForm" method="post" action="infoHandler.jsp" onsubmit = "return validate_form()">
	<div align="center">
	<table>
	<tr>
